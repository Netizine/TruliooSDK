...
namespace TruliooSDK.Controllers
{
    public interface IConfigurationController
    {
        ...
        /// <return> Returns the List{string} response from the API call</return>
        List<Country> GetCountryCodes(string configurationName);
        ...
        object GetFields(Country country);
        ...
        /// <param name="configurationName">Required parameter: The product configuration. Currently defaults to "Identity Verification" for all products.</param>
        /// <return>Returns the object response from the API call</return>
        object GetFields(Country country, string configurationName);
        ...
        /// <param name="country">The country which serializes to the country alpha2 code</param>
        /// <return>Returns the object response from the API call</return>
        Task<object> GetFieldsAsync(Country country);
        ...
        /// <param name="configurationName">Required parameter: The product configuration. Currently defaults to "Identity Verification" for all products.</param>
        /// <return>Returns the object response from the API call</return>
        Task<object> GetFieldsAsync(Country country, string configurationName);
        ...
        /// <param name="configurationName">Required parameter: The product configuration. Currently defaults to "Identity Verification" for all products.</param>
        /// <return>Returns the object response from the API call</return>
        object GetRecommendedFields(Country country);
        ...
        /// <param name="configurationName">Required parameter: The product configuration. Currently defaults to "Identity Verification" for all products.</param>
        /// <return>Returns the object response from the API call</return>
        object GetRecommendedFields(Country country, string configurationName);
        ...
        /// <param name="country">The country which serializes to the country alpha2 code</param>
        /// <return>Returns the object response from the API call</return>
        Task<object> GetRecommendedFieldsAsync(Country country);
        ...
        /// <param name="configurationName">Required parameter: The product configuration. Currently defaults to "Identity Verification" for all products.</param>
        /// <return>Returns the object response from the API call</return>
        Task<object> GetRecommendedFieldsAsync(Country country, string configurationName);
        ...
        /// <param name="country">The country which serializes to the country alpha2 code</param>
        /// <return> Returns the List{string} response from the API call</return>
        List<string> GetConsents(Country country);
        ...
        /// <param name="configurationName">Required parameter: The product configuration. Currently defaults to "Identity Verification" for all products.</param>
        /// <return> Returns the List{string} response from the API call</return>
        List<string> GetConsents(Country country, string configurationName);
